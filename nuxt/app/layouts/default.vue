...
<template>
    <div>
        ...
        <Transition name="goup" mode="out-in">
            <div class="cookies" v-if="!isCookieAccepted || toggleCookiesMenu"  :class="{ active: isCustomizing }">
...
/* ~16px do 18px */
.cookies { position: fixed; z-index: 8000; bottom: 0; left: 50%; min-width: 100%; transform: translateX(-50%); background: #fff; border-radius: 10px; box-shadow: 0px 0px 20px 0px rgba(0, 0, 0, 0.1); transition: box-shadow 0.2s ease; }
